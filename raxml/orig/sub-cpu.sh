...
##### Executar esse para CPU ######
    EXEC="java -Xms64m -Xmx24G -jar /scratch/app/beast/1.10/lib/beast.jar -overwrite -beagle -beagle_CPU -beagle_SSE -threads $SLURM_CPUS_PER_TASK -beagle_instances 4 ${input_file}"
